...
const MasterLayout = (props) => {
  ...
  return (
    <Fragment>
      ...
      1. top nav
       this is fixed so nothing to do with it


      2. sidebar
        sidebar is by default open. so now this main content has two parts
        but when the sidebar is close then only main content will have the whole
        page content
      3. main content
    */}

      {/*
      THE WAY SIDENAV WORK
      > sidenav has a fixed position property
      > when open class added it wil have a widte of 220px
      > then content will have a margin-left of 220px

      > when close class added it will have a width of 0px
      > then content will have a margin-left of 0px
      thats it. 
      i can add any kind of sidenav here and just add its width 220px while open
      and 0px while close
    */}
