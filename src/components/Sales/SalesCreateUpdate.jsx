...
import { OnChangeSaleInput, RemoveSaleItem, ResetSaleFormValue, SetSaleItemList } from "../../redux/state-slice/sale-slice";
...
const SalesCreateUpdate = () => {
  ...
  useEffect(() => {
    ...
    let GrandTotal = total + Number(SaleFormValue.VatTax) - Number(SaleFormValue.Discount) + Number(SaleFormValue.OtherCost) + Number(SaleFormValue.ShippingCost);
    store.dispatch(OnChangeSaleInput({ Name: "GrandTotal", Value: GrandTotal }))
              ...
              <div className="card-body">
                <div className="row">
                  ...
                  <div className="col-12 p-1">
                    ...
                    <input onChange={(e) => { store.dispatch(OnChangeSaleInput({ Name: "VatTax", Value: e.target.value })) }}
                  ...
                  <div className="col-12 p-1">
                    ...
                    <input disabled onChange={(e) => { store.dispatch(OnChangeSaleInput({ Name: "GrandTotal", Value: e.target.value })) }} className="form-control form-control-sm" type="number" value={SaleFormValue['GrandTotal']} />
                  </div>
